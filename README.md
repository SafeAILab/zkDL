...
- [ ] [2023/10/1] v1.0.0 is released. New features:
	- The first-known CUDA-based zkML platform.
 	...
 	- Supporting ZKP for MLP with customized width and depth (other architectures will be coming soon). Allow users to load their own NNs from PyTorch (.pt file).
